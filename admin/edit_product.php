...
<head>
    ...
    <title>CHỈNH SỬA | 5THEWAY® ADMIN</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .img-upload-box img { max-width: 100%; height: 250px; object-fit: cover; border-radius: 8px; margin-bottom: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.08); }
...
<body>
            ...
            <div class="edit-grid">
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ten_sp" class="form-control" value="<?php echo htmlspecialchars($data['TenSP']); ?>" required>
                    </div>

                    <div class="form-group">
                        <label>Mô tả chi tiết</label>
                        <textarea name="mota" class="form-control"><?php echo htmlspecialchars($data['MoTa']); ?></textarea>
                    </div>

                    <div class="row-flex">
                        <div class="form-group">
                            <label>Giá bán (VNĐ)</label>
                            <input type="number" name="gia_niemyet" class="form-control" value="<?php echo $data['GiaNiemYet']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label>Số lượng trong kho</label>
                            <input type="number" name="soluongton" class="form-control" value="<?php echo $data['SoLuongTon']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row-flex">
                        <div class="form-group">
                            ...
                            <input type="text" name="size" class="form-control" value="<?php echo htmlspecialchars($data['Size']); ?>" placeholder="S, M, L, XL...">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="ma_loai" class="form-control">
                                ...
                                while($row_loai = mysqli_fetch_assoc($res_loai)) {
                                    $sel = ($row_loai['MaLoai'] == $data['MaLoai']) ? "selected" : "";
                                    echo "<option value='".$row_loai['MaLoai']."' $sel>".$row_loai['TenLoai']."</option>";
                                }
                                ?>
                            </select>
                        </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    <div class="card">
                        ...
                        <div class="img-upload-box">
                            <img src="../assets/img/<?php echo $data['HinhAnh']; ?>" id="previewImg" onerror="this.src='https://via.placeholder.com/300x400?text=5THEWAY'">
                            <input type="file" name="hinh_anh" id="fileInput" style="font-size: 11px; margin-top: 10px;">
                        </div>
                        <p style="font-size: 11px; color: #999; margin-top: 10px; font-style: italic;">* Để trống nếu không muốn đổi ảnh.</p>
                    </div>

                    <button type="submit" name="btn_update" class="btn-submit">
                        <i class="fa-solid fa-check-double"></i> CẬP NHẬT NGAY
                    </button>
    ...
    <script>
        // Xử lý xem trước ảnh khi Admin chọn file mới
